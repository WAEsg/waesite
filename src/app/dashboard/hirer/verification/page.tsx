...
export default async function HirerVerificationPage() {
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className={`p-6 ${glassCardLight}`}>
        <p className="text-sm text-slate">
          Your identity is verified via Stripe Identity. This keeps every hirer on
          WaeWork accountable to the talent they work with.
        </p>
