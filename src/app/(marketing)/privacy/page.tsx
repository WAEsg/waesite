...
export default async function PrivacyPage() {
  const raw = await readLegalDocument("privacy");
  // Same reasoning as the Terms page — the card header already renders
  // "Privacy Policy", so drop the doc's redundant leading heading line.
      ...
      <div className="px-4 pt-16 pb-16 sm:pt-20">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mt-3 text-balance font-display text-display leading-[1.02] font-extrabold tracking-[-0.03em] text-ink-navy">
            Privacy <span className="text-voyage-blue">Policy</span>
          </h1>
          <p className="mt-3 text-lede leading-[1.55] text-slate">
            Our Privacy Policy hasn&apos;t had a formal legal review yet — the draft below is what governs data
            handling in the meantime, and will be replaced with the reviewed version before a full public launch.
          </p>

          <div className="mt-8 rounded-2xl border border-line bg-white p-[clamp(22px,3.4vw,40px)] shadow-1">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-bold text-ink-navy">Privacy Policy</h2>
